...
export default function AuthPage() {
  ...
  const handleRegisterSubmit = async () => {
    ...
    try {
      const response = await api.post('/api/auth/register', { phone, name, code })
      login(response.data.token, response.data.user)
      router.push('/order')
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-[#f8f9fa] flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 pb-8">
        ...
        <motion.p
          ...
          className="text-dark-400 text-xs tracking-[0.25em] uppercase mb-10"
        >
          ...
          <AnimatePresence mode="wait">
            ...
            {step === 'register' && (
              ...
              >
                ...
                <p className="text-dark-300 text-sm mb-8">Как к вам обращаться?</p>
